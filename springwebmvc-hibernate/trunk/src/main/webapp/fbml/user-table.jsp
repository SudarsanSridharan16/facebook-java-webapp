...
<fb:header><a href="http://developers.facebook.com/docs/reference/fbml/user-table">fb:user-table</a></fb:header>

<p style="color: red; font-weight: bold;">Only works in profile pages for now</p>
<p>Renders a table, each cell of which contains a thumbnail and name for a particular user, similar to the Mutual Friends table on profile pages.</p>
